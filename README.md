...
### ⚡ Software Engineer | Core Web Architecture, Ethical Hacking & Data Insights

I engineer reliable full-stack applications, conduct penetration testing to uncover vulnerabilities, and extract clear intelligence from complex datasets.

---

### 🔍 Core Capabilities

*   **Core Web Architecture:** Developing full-stack web applications and secure Web3 decentralized systems.
*   **Ethical Hacking:** Executed web application penetration testing to secure backend APIs and system infrastructure.
*   **Data Insights:** Processing system metrics and datasets to track performance and isolate anomalies.
